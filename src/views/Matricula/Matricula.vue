<template>
    <v-container fluid class="px-0 py-0">
        <v-dialog v-model="showAdd" fullscreen :scrim="false" transition="dialog-bottom-transition">
            <v-card>
                    ...
                    <v-container class="d-flex justify-center flex-column align-center">
                        <v-row>
                            <v-col cols="12" md="6" lg="4">
                                <LoginRegister title="Matrícula" subtitle="Registre un nuevo proceso de matrícula"
                                    maxwidth="600px"  :submit="submit" :showavatar="false">
        ...
        <v-row>
            <v-col cols="12">
                <v-card>
                    ...
                    <v-data-table height="400px" v-model:items-per-page="itemsPerPage" :headers="headers"
                        :items="asistencia" item-value="grado" class="elevation-2">
